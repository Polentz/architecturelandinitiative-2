            ...
            <div class="audio-player-wrapper">
                <div class="audio-play ui-button">
                    <svg class="play-icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M8.5 8.80902L30.882 20L8.5 31.191L8.5 8.80902Z" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <svg class="pause-icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0.5" y="0.5" width="39" height="39" stroke="#fff" />
                        <path d="M16 8L16 32M24 8L24 32" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
                <div class="audio-time">
                    <span class="audio-progress">0:00</span> / <span class="audio-duration"></span>
                </div>
                <div class="audio-volume ui-button">
                    <svg class="volume-icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0.5" y="0.5" width="39" height="39" stroke="#fff" />
                        <path d="M15.5377 24.5991L15.4048 24.5H15.2389H8.43457V15.5H15.2389H15.4048L15.5377 15.4009L24.1302 8.9963V31.0037L15.5377 24.5991Z" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M28.9346 16V24M32.065 14V26" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <svg class="mute-icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0.5" y="0.5" width="39" height="39" stroke="#fff" />
                        <path d="M15.6032 24.5991L15.4702 24.5H15.3043H8.5V15.5H15.3043H15.4702L15.6032 15.4009L24.1957 8.9963V31.0037L15.6032 24.5991Z" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M32 18L28 22M32 22L28 18" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            </div>
            <div class="audio-player-wrapper">
    ...
    <figure class="gallery-item document-item" <?= $dataset ?>>
        <div class="document-wrapper">
            <?php if ($media->caption()->isNotEmpty()) : ?>
                <?= $media->caption()->kt() ?>
            <?php endif ?>
            <a href="<?= $media->url() ?>" target="_blank" rel="noopener noreferrer" class="ui-button">
