<header class="header">
    <!-- <h1 class="header-headline">
        ...
        <?php if (!$page->isHomePage()) : ?>
            <span class="logo-element"><?php if ($page->depth() > 1) : ?><?= $page->parent()->title() ?>: <?php endif ?><?= $page->title() ?></span>
        <?php endif ?>
    </h1> -->
    ...
    <nav class="header-nav">
        ...
        <?php foreach ($site->children()->listed()->filterBy('template', 'in', ['projects', 'tools', 'timeline', 'about', 'home']) as $page) : ?>
